...
p = Player.Evaluator(year=2022, week=17)
l = League.Evaluator('purdue-2022', week=17, players=p.players, draft_recap_week=13)

Builder('purdue-2022', week=14, n_sim=300).build_report()
