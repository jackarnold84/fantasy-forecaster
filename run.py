...
builder.Builder('purdue-2022', week=5, n_sim=20000).build_report()

builder.Builder('morton-2022', week=5, n_sim=10000).build_report()

builder.Builder('capitalone-2022', week=5, n_sim=10000).build_report()
